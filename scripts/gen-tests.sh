...
ucloud-model sdk test \
    ...
    --output tests/test_services/test_set_25.py \
    --name 25
...
ucloud-model sdk test \
    --lang python3 \
    --template ${U_MODEL_HOME}/providers/python/templates/testing.tpl \
    --output tests/test_services/test_set_612.py \
    --name 612

ucloud-model sdk test \
    --lang python3 \
    --template ${U_MODEL_HOME}/providers/python/templates/testing.tpl \
    --output tests/test_services/test_set_613.py \
    --name 613

ucloud-model sdk test \
    --lang python3 \
    --template ${U_MODEL_HOME}/providers/python/templates/testing.tpl \
    --output tests/test_services/test_set_614.py \
    --name 614
...
ucloud-model sdk test \
    --lang python3 \
    --template ${U_MODEL_HOME}/providers/python/templates/testing.tpl \
    --output tests/test_services/test_set_2378.py \
    --name 2378
